...
program.name("downly").description("Next.js application for downloading files").version(packageJson.version)
...
program
  ...
  .action(async(options) => {
    ...
    const standaloneServerPath = path.join(packageDir, 'build', 'standalone', 'server.js')
